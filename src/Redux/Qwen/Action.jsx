import { QWEN_BASE_URL } from "../../config/ApiConfig";
import { RUN_QWEN_FAILURE, RUN_QWEN_REQUEST, RUN_QWEN_SUCCESS } from "./ActionType";
...
export const runQwen = (image, complex_explanation) => async (dispatch) => {
  try {
    ...
    const client = await Client.connect(QWEN_BASE_URL);
